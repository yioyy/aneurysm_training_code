...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        # if self.configuration_manager.batch_size < 100:
        #     self.num_iterations_per_epoch = int(400)
        # else:
        #     self.num_iterations_per_epoch = int(100)
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
            ...
            for i in range(self.num_deep_supervision_levels):
                ...
                individual_dice_losses[dice_loss_name] = self.individual_dice_losses[f'dice_loss{i}'](output_seg, target)
