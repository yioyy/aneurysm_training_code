...
class DefaultPreprocessor(object):
    ...
    def run_case(self, image_files: List[str], seg_file: Union[str, None], vessel_file: Union[str, None], dilate_file: Union[str, None], plans_manager: PlansManager,
    ...
    def run_case_save(self, output_filename_truncated: str, image_files: List[str], seg_file: str, vessel_file: str, dilate_file: str,
                      plans_manager: PlansManager, configuration_manager: ConfigurationManager,
                      dataset_json: Union[dict, str]):
        data, seg, properties = self.run_case(image_files, seg_file, vessel_file, dilate_file, plans_manager, configuration_manager, dataset_json)
...
def example_test_case_preprocessing():
    ...
    data, _, properties = pp.run_case(input_images, seg_file=None, vessel_file=None, plans_manager=plans_manager,
