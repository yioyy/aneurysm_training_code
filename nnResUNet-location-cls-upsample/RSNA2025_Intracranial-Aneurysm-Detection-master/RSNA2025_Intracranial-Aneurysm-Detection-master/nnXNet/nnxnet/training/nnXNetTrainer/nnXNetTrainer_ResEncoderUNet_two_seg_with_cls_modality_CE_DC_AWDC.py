...
from nnxnet.training.nnXNetTrainer.nnXNetTrainer_ResEncoderUNet_two_seg_with_cls_modality import nnXNetTrainer_ResEncoderUNet_two_seg_with_cls_modality
    
class nnXNetTrainer_ResEncoderUNet_two_seg_with_cls_modality_CE_DC_AWDC(nnXNetTrainer_ResEncoderUNet_two_seg_with_cls_modality):
