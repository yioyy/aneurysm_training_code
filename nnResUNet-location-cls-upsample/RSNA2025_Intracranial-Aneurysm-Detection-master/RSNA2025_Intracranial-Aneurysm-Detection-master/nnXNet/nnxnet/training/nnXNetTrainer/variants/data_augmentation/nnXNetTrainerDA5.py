...
from nnxnet.training.data_augmentation.custom_transforms.transforms_for_dummy_2d import Convert3DTo2DTransform, \
...
class nnXNetTrainerDA5(nnXNetTrainer):
...
class nnXNetTrainerDA5ord0(nnXNetTrainerDA5):
...
class nnXNetTrainerDA5Segord0(nnXNetTrainerDA5):
    def get_dataloaders(self):
        """
        changed order_resampling_data, order_resampling_seg
        """
...
class nnXNetTrainerDA5_10epochs(nnXNetTrainerDA5):
