...
from nnxnet.training.nnXNetTrainer.variants.benchmarking.nnXNetTrainerBenchmark_5epochs import (
    nnXNetTrainerBenchmark_5epochs,
)
from nnxnet.utilities.label_handling.label_handling import determine_num_input_channels


class nnXNetTrainerBenchmark_5epochs_noDataLoading(nnXNetTrainerBenchmark_5epochs):
    def __init__(
        self,
        plans: dict,
        configuration: str,
