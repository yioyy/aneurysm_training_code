...
from nnxnet.training.loss.compound_losses import DC_and_BCE_loss, DC_and_CE_loss
...
class nnXNetTrainerDiceLoss(nnXNetTrainer):
...
class nnXNetTrainerDiceCELoss_noSmooth(nnXNetTrainer):
    def _build_loss(self):
        # set smooth to 0
