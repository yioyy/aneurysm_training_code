    ...
    try:
        ...
        if overwrite_existing or not isfile(data_npy):
            try:
                ...
                print(f"Unable to open preprocessed file {npz_file}. Rerun nnXNet_preprocess!")
                raise e
        ...
        if verify_npy:
            try:
                ...
                if fail_ctr < 2:
                    ...
                    raise RuntimeError("Unable to fix unpacking. Please check your system or rerun nnXNet_preprocess")
...
if __name__ == '__main__':
    unpack_dataset('/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_preprocessed/Dataset002_Heart/2d')