...
class nnXNetDataLoader2D(nnXNetDataLoaderBase):
...
if __name__ == '__main__':
    folder = '/yinghepool/shipengcheng/Dataset/nnUNet/nnXNet_preprocessed/Dataset004_Hippocampus/2d'
    ds = nnXNetDataset(folder, None, 1000)  # this should not load the properties!
    dl = nnXNetDataLoader2D(ds, 366, (65, 65), (56, 40), 0.33, None, None)
    a = next(dl)
