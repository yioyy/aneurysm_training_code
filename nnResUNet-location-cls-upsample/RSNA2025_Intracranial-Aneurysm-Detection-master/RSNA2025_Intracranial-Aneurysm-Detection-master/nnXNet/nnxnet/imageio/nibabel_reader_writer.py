...
class NibabelIO(BaseReaderWriter):
    ...
    IMPORTANT: Run nnXNet_plot_overlay_pngs to verify that this did not destroy the alignment of data and seg!
    """
    ...
    def read_images(self, image_fnames: Union[List[str], Tuple[str, ...]]) -> Tuple[np.ndarray, dict]:
        ...
        if not self._check_all_same(spacings_for_nnxnet):
            print('ERROR! Not all input images have the same spacing_for_nnxnet! This might be caused by them not '
