...
# the Evaluator class of the previous nnX-Net was great and all but man was it overengineered. Keep it simple
...
if __name__ == '__main__':
    folder_ref = '/yinghepool/shipengcheng/Dataset/nnUNet/nnXNet_raw/Dataset004_Hippocampus/labelsTr'
    folder_pred = '/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_results/Dataset004_Hippocampus/nnXNetModule__nnXNetPlans__3d_fullres/fold_0/validation'
    output_file = '/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_results/Dataset004_Hippocampus/nnXNetModule__nnXNetPlans__3d_fullres/fold_0/validation/summary.json'
