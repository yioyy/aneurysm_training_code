...
class DatasetFingerprintExtractor(object):
    def __init__(self, dataset_name_or_id: Union[str, int], num_processes: int = 8, verbose: bool = False):
        ...
        self.input_folder = join(nnXNet_raw, dataset_name)
    ...
    def run(self, overwrite_existing: bool = False) -> dict:
        ...
        # reliably write in nnXNet_preprocessed and nnXNet_results, so nnXNet_preprocessed it is
        preprocessed_output_folder = join(nnXNet_preprocessed, self.dataset_name)
