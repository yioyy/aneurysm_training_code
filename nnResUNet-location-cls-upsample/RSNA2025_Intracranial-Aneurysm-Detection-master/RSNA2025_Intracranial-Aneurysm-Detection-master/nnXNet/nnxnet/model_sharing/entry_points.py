from nnxnet.model_sharing.model_download import download_and_install_from_url
from nnxnet.model_sharing.model_export import export_pretrained_model
from nnxnet.model_sharing.model_import import install_model_from_zip_file
...
def print_license_warning():
    ...
    print("Using the pretrained model weights is subject to the license of the dataset they were trained on. Some "
          ...
          "nnXNet_print_pretrained_model_info(task_name) to see a summary of the dataset and where to find its license!")
    print('######################################################')
    print('')
...
def export_pretrained_model_entry():
    ...
    parser.add_argument('-tr', required=False, type=str, default='nnXNetTrainer', help='Trainer class')
    parser.add_argument('-p', required=False, type=str, default='nnXNetPlans', help='plans identifier')
