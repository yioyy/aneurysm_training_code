...
def download_and_install_from_url(url):
    assert nnXNet_results is not None, "Cannot install model because network_training_output_dir is not " \
    ...
    tempfile = join(home, f'.nnxnetdownload_{str(random_number)}')
