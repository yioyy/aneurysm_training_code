...
def get_allowed_n_proc_DA():
    ...
    IMPORTANT: if the environment variable nnXNet_n_proc_DA is set it will overwrite anything in this script
    (see first line).
    ...
    if 'nnXNet_n_proc_DA' in os.environ.keys():
        use_this = int(os.environ['nnXNet_n_proc_DA'])
    else:
