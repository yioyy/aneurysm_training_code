...
from nnxnet.paths import nnXNet_results
...
def get_output_folder(dataset_name_or_id: Union[str, int], trainer_name: str = 'nnXNetTrainer',
                      plans_identifier: str = 'nnXNetPlans', configuration: str = '3d_fullres',
                      fold: Union[str, int] = None) -> str:
    tmp = join(nnXNet_results, maybe_convert_to_dataset_name(dataset_name_or_id),
...
if __name__ == '__main__':
    ...
    path = '/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_results/Dataset002_Heart/nnXNetModule__nnXNetPlans__3d_fullres'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    path = 'Dataset002_Heart/nnXNetModule__nnXNetPlans__3d_fullres'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    path = '/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_results/Dataset002_Heart/nnXNetModule__nnXNetPlans__3d_fullres/fold_all'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    try:
        path = '/yinghepool/shipengcheng/Dataset/nnUNet/nnUNet_results/Dataset002_Heart/'
        print(parse_dataset_trainer_plans_configuration_from_path(path))
