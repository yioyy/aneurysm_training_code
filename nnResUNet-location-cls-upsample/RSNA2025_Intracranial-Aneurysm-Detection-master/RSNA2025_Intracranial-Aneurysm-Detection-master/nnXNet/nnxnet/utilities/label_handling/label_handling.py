...
from nnxnet.utilities.helpers import softmax_helper_dim0
...
def get_labelmanager_class_from_plans(plans: dict) -> Type[LabelManager]:
    if 'label_manager' not in plans.keys():
        ...
        labelmanager_class = recursive_find_python_class(join(nnxnet.__path__[0], "utilities", "label_handling"),
                                                         plans['label_manager'],
                                                         current_module="nnxnet.utilities.label_handling")
