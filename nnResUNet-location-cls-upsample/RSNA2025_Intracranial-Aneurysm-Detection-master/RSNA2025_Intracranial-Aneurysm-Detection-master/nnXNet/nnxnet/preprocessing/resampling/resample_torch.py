...
from nnxnet.preprocessing.resampling.default_resampling import determine_do_sep_z_and_axis
...
if __name__ == '__main__':
    ...
    img_file = '/media/isensee/raw_data/nnXNet_raw/Dataset027_ACDC/imagesTr/patient041_frame01_0000.nii.gz'
    seg_file = '/media/isensee/raw_data/nnXNet_raw/Dataset027_ACDC/labelsTr/patient041_frame01.nii.gz'
    io = SimpleITKIO()
    ...
    ret_nosep = resample_torch_fornnxnet(use, target_shape, spacing, spacing, is_seg)
    ret_sep = resample_torch_fornnxnet(use, target_shape, spacing, spacing, is_seg, force_separate_z=False)
